...
function migrate() {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, json, originDataPath, commonAsyncDataPath, commonAsyncData, newUrl200Path, newContent, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    commonAsyncData = fs.readFileSync(originDataPath.url200, { encoding: 'utf8' });
                    console.info("here");
                    newUrl200Path = path.resolve(commonAsyncDataPath, path.basename(originDataPath.url200));
